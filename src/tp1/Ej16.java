...
public class Ej16 {
    ...
    public static void main(String[] args){
        /*. Realiza un programa que permita ingresar la cantidad de inscriptos a una conferencia y la
            cantidad de asientos disponibles en el auditorio. Debes indicar si alcanzan los asientos, Si los
            asientos no alcanzaran indicar cuantos faltan para que todos los inscriptos puedan sentarse.
         */
