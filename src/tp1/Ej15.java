...
public class Ej15 {
    ...
    public static void main(String[] args) {
        /*  Para entrar a la montaÃ±a rusa Miedo a las alturas, algo mas chica y tranquila que la anterior,
            alcanza con que se cumpla solamente una de las siguientes condiciones: ser mayor de 6 años
            o medir mas de 1,50 metros. Realiza el mismo procedimiento que con el ejercicio anterior
